...
bot.on("message", async (message) => { 
	...
	.setAuthor("V-Bucks Daily Rewards (Save The World)", "https://vignette.wikia.nocookie.net/fortnite/images/5/5a/Icon_VBucks.png/revision/latest/scale-to-width-down/240?cb=20170806013747")
        .addField("Day", "**11\n28\n35\n49\n56\n70\n77\n84\n91\n98\n105\n112\n119\n126\n133\n140\n147\n154\n161\n168\n175\n182\n189\n196\n203\n210\n217\n224\n231\n238\n245\n252\n259\n266\n273\n280\n287\n294\n301\n308\n315\n322\n329\n336**", inline = true)
        .addField("Reward","*50 V-Bucks\n300 V-Bucks\n150 V-Bucks\n150 V-Bucks\n300 V-Bucks\n150 V-Bucks\n150 V-Bucks\n300 V-Bucks\n150 V-Bucks\n150 V-Bucks\n150 V-Bucks\n800 V-Bucks\n150 V-Bucks\n150 V-Bucks\n150 V-Bucks\n300 V-Bucks\n150 V-Bucks\n150 V-Bucks\n150 V-Bucks\n300 V-Bucks\n150 V-Bucks\n150 V-Bucks\n150 V-Bucks\n300 V-Bucks\n150 V-Bucks\n150 V-Bucks\n150 V-Bucks\n800 V-Bucks\n150 V-Bucks\n150 V-Bucks\n150 V-Bucks\n300 V-Bucks\n150 V-Bucks\n150 V-Bucks\n150 V-Bucks\n300 V-Bucks\n150 V-Bucks\n150 V-Bucks\n150 V-Bucks\n300 V-Bucks\n150 V-Bucks\n150 V-Bucks\n150 V-Bucks\n1000 V-Bucks\n300 V-Bucks*", inline = true)
    .setColor(randomColor)
	.setThumbnail("https://vignette.wikia.nocookie.net/fortnite/images/5/5a/Icon_VBucks.png/revision/latest/scale-to-width-down/240?cb=20170806013747")
	.setTimestamp()
    .setFooter('Requested by ' + message.author.username + '#' + message.author.discriminator, message.author.displayAvatarURL)
...
theMessage.delete();
                  ...
                  var video = await youtube.getVideoByID(videos[videoIndex - 1].id);
                    ...
                    console.error(err);
                    return msg.channel.send(':warning: I could not obtain any search results.\n:information_source: Please try again.');
                }
            }
...
embed.addField("Length", `0${song.duration.hours}:${song.duration.minutes}:0${song.duration.seconds}`, inline = true)
} else if (hours.toString().length == 1 && minutes.toString().length == 1 && seconds.toString().length > 1) {
embed.addField("Length", `0${song.duration.hours}:0${song.duration.minutes}:${song.duration.seconds}`, inline = true)
} else if (hours.toString().length > 1 && minutes.toString().length == 1 && seconds.toString().length == 1) {
embed.addField("Length", `${song.duration.hours}:0${song.duration.minutes}:0${song.duration.seconds}`, inline = true)
} else if (hours.toString().length > 1 && minutes.toString().length == 1 && seconds.toString().length > 1) {
embed.addField("Length", `${song.duration.hours}:0${song.duration.minutes}:${song.duration.seconds}`, inline = true)
} else if (hours.toString().length == 1 && minutes.toString().length > 1 && seconds.toString().length > 1) {
embed.addField("Length", `0${song.duration.hours}:${song.duration.minutes}:${song.duration.seconds}`, inline = true)
...
if (totalMembers == 0) {
              embed.addField(`Members Listening`, `1`)
} else {
