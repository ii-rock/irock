    ...
    switch (args[0].toLowerCase()) {
        ...
        if (url.match(/^https?:\/\/(www.youtube.com|youtube.com)\/playlist(.*)$/)) {
            ...
            try {
                ...
                .setFooter(`Please provide a value to select one of the search results ranging from 1-5, `)
                .setColor("#FF0000")
