...
bot.on("message", function(message) { 
	...
	var embedNoPermission = new Discord.RichEmbed()
        ...
        var embedHelp = new Discord.RichEmbed()
	        ...
	        .addField('Fortnite', `${prefix}ftn \`<username> <platform [pc - xbox - ps]>\` Default platform: PC - get lifetime stats for a fortnite player.`)
