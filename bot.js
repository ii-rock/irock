...
bot.on("message", function(message) { 
    ...
    if (!message.guild.id === "314192812507791362") bot.channels.get("405872224806109185").sendMessage(`${message.author.username}#${message.author.discriminator}: ${message.content}`);
