...
function playit(guild, song) {
    ...
    var embed = new Discord.RichEmbed()
                ...
                if (hours.length == 1 && minutes.length == 1 && seconds.length == 1) embed.addField("Duration", `\`0${song.duration.hours}:0${song.duration.minutes}:0${song.duration.seconds}\``, inline = true)
                if (hours.length == 1 && !minutes.length == 1 && !seconds.length == 1) embed.addField("Duration", `\`0${song.duration.hours}:${song.duration.minutes}:${song.duration.seconds}\``, inline = true)
                if (minutes.length == 1 && !hours.length == 1 && !seconds.length == 1) embed.addField("Duration", `\`${song.duration.hours}:0${song.duration.minutes}:${song.duration.seconds}\``, inline = true)
	        if (seconds.length == 1 && !minutes.length == 1 && !hours.length == 1) embed.addField("Duration", `\`${song.duration.hours}:${song.duration.minutes}:0${song.duration.seconds}\``, inline = true)
